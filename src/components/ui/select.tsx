...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("pointer-events-none -mx-1 my-1.5 h-px bg-black/5", className)}
      {...props}
    />
  )
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        "z-10 flex cursor-default items-center justify-center bg-white py-1.5 text-[#111] [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
